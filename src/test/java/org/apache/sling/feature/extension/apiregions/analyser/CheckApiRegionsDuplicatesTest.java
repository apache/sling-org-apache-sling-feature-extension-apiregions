...
public class CheckApiRegionsDuplicatesTest extends AbstractApiRegionsAnalyserTaskTest<CheckApiRegionsDuplicates> {
    ...
    public void testDetectDuplicates() throws Exception {
        List<String> errors = execute(
                "[{\"name\": \"global\",\"exports\": [\"org.osgi.util.function\"]},{\"name\": \"deprecated\",\"exports\": [\"org.osgi.util.function\"]}]");
        ...
        assertTrue(
                errors.iterator()
                        .next()
                        .startsWith(
                                "Regions 'global' and 'deprecated' defined in feature 'org.apache.sling.testing:org.apache.sling.testing.apiregions:1.0.0' declare both 1 package(s)"));
    }
}
