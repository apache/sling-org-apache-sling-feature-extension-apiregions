...
public class CheckApiRegionsTest extends AbstractApiRegionsAnalyserTaskTest<CheckApiRegions> {
    ...
    public void testNotValidApiRegionJson() throws Exception {
        List<String> errors =
                execute("[{\"name\": \"global\",\"exports\": [\"org.osgi.util.function.doesnotexist\"]}]");
        ...
        assertTrue(
                errors.iterator()
                        .next()
                        .startsWith(
                                "Region 'global' defined in feature 'org.apache.sling.testing:org.apache.sling.testing.apiregions:1.0.0' declares 1 package which is not exported by any bundle"));
    }
